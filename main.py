...
if __name__ == '__main__':
    ...
    Training
    """
    evognn = EvoGNN(H_0=H_0, adjlists=u_adjlists, T=args.T, K=args.K)
    ...
    models = [evognn, attr_infer, link_pred]
    ...
    print('===' * 30)
    print('Training EvoGNN ({:,})...'.format(args.epochs), flush=True)
    for ep in range(args.epochs):
        ...
        ''' Forward '''
        H_ts_train, H_ts_forecast = evognn(args.t_train, args.t_forecast)
